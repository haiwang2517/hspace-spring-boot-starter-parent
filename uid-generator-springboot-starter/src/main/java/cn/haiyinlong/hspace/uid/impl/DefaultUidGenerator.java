...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
  ...
  /** Hspace 配置文件 {@link cn.haiyinlong.hspace.uid.impl.UidProperties} */
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    bitsAllocator =
        new BitsAllocator(
            uidProperties.getTimeBits(), uidProperties.getWorkerBits(), uidProperties.getSeqBits());
    ...
    LOGGER.info(
        ...
        uidProperties.getTimeBits(),
        uidProperties.getWorkerBits(),
        uidProperties.getSeqBits(),
        workerId);
  }
  ...
  public String parseUID(long uid) {
    ...
    Date thatTime =
        new Date(TimeUnit.SECONDS.toMillis(uidProperties.getEpochSeconds() + deltaSeconds));
  ...
  protected synchronized long nextId() {
    ...
    return bitsAllocator.allocate(
        currentSecond - uidProperties.getEpochSeconds(), workerId, sequence);
  }
